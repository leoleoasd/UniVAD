...
class MadsimDataset(data.Dataset):
	...
	def __getitem__(self, index):
		...
		return {'img_pil': np.array(img_pil.resize((448, 448))), 'img': img, 'img_mask': img_mask, 'cls_name': cls_name.replace("_", " "), 'anomaly': anomaly, 'anomaly_class': specie_name.replace("_", " "),
